$(document).ready(function () {
    ...
    function AppViewModel() {
        ...
        self.addIdentity = function () {
            connection.invoke("AddIdentityName", userName).then(function () {
            });
        }

        // join room
        self.joinRoom = function (room) {
            connection.invoke("Join", room.name(), userName).then(function () {
        ...
        self.roomList = function () {
            fetch('https://localhost:5001/api/RoomChats')
